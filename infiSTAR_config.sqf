...
/* ViewDistance Value   */ _VDV = 4000;
/* ObjectViewDistance   */ _VOV = 4000;
...
_startAsNormal =
[
	'76561198045733799','76561198009454590'
];
...
[
	[
		['76561198045733799','76561198009454590'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> vi9025348121";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"01-06-2022 02-29-05 - v0260");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [01-06-2022 02-29-05 - v0260]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
...
/* **************infiSTAR Copyright�� 2011 - 2022 All rights reserved.************** */
