...
A3W_bleedingTime = 60*5;             // Time in seconds for which to allow revive after a critical injury (minimum 10 seconds)
...
A3W_extDB_IniName = "a3wasteland.ini"; // Name of the INI file in extDB\db_custom to be used
