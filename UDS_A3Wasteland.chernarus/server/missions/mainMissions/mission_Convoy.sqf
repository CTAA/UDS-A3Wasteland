...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["CUP_B_Mastiff_HMG_GB_W", "CUP_B_Kamaz_CDF", "CUP_B_Mastiff_HMG_GB_W"]
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted by armed vehicles.", _vehicleName, mainMissionColor];
