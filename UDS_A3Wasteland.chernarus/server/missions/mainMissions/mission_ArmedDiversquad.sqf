...
_setupObjects =
{
	...
	_vehicleClass = ["CUP_B_RHIB2Turret_USMC", "CUP_B_RHIB2Turret_USMC", "CUP_B_RHIB2Turret_USMC"] call BIS_fnc_selectRandom;
...
_successExec =
{
	...
	_successHintMessage = "The sunken crates have been captured.";
};
