...
["B_CargoNet_01_ammo_F",[0,0,0],0,{[_this, selectRandom missionBoxArray] call fn_refillbox;}], // leave crate as-is, disallow damage, lock crate until mission complete.
...
["Box_East_WpsSpecial_F",[7.07523,4.21517,0],0,{[_this, selectRandom missionBoxArray] call fn_refillbox;}],
["Box_East_WpsSpecial_F",[-7.375,-4.75,0],0,{[_this, selectRandom missionBoxArray] call fn_refillbox;}],
