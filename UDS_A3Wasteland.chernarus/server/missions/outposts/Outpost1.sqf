...
[
	...
	["Box_IND_WpsSpecial_F", [-6.24817, 8.69141, 0], 180, { [_this, selectRandom missionBoxArray] call fn_refillbox }],
	...
	["Box_East_WpsSpecial_F", [6.26294, -10.02422, 0], 180, { [_this, selectRandom missionBoxArray] call fn_refillbox }],
